...
La solution présentée traite le problème d'allocation de ressources, et peut être enrichie en explorant d'autres aspects de l'architecture Fog.\par
Dû aux limites de l'environnement de simulation IFogSim, nous avons eu besoin de l'enrichir avec de nouvelle fonctionnalités et de corriger certains comportements erronés.\par
Nous pouvons énumérer les perspectives suivantes permettant notamment d'éliminer les hypothèses formulées dans le chapitre de conception :
\begin{itemize}
